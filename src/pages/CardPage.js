...
const CardPage = () => {
  ...
  const fetchNickname = async (userId) => {
    try {
      const response = await axios.post('https://api.nodejstrello.site/api/user/get', {
        userId: userId,
      });
  ...
  const fetchCardAndCommentsDetails = async () => {
    try {
      const cardResponse = await axios.get(`https://api.nodejstrello.site/api/cards/${cardId}`);
      const cardData = cardResponse.data;
      const commentsResponse = await axios.get(`https://api.nodejstrello.site/api/cards/${cardId}/comments`);
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      await axios.delete(`https://api.nodejstrello.site/api/cards/${cardId}/comments/${commentId}`);
  ...
  const handleCommentSubmit = async () => {
    try {
      await axios.post(`https://api.nodejstrello.site/api/cards/${cardId}/comments`, {
  ...
  const saveEditedComment = async () => {
    try {
      await axios.put(`https://api.nodejstrello.site/api/cards/${cardId}/comments/${editingCommentId}`, {
