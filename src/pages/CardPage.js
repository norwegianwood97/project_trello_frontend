...
const CardPage = () => {
  ...
  const fetchCardAndCommentsDetails = async () => {
    try {
      ...
      const commentsResponse = await axios.get(`/api/cards/${cardId}/comments`);
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      await axios.delete(`/api/cards/${cardId}/comments/${commentId}`);
  ...
  const saveEditedComment = async () => {
    try {
      await axios.put(`/api/cards/${cardId}/comments/${editingCommentId}`, {
